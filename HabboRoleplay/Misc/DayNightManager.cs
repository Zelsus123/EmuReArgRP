        ...
        public static void ActiveCycle(int Intensity = 255)
        {
            try
            {
                ...
                foreach (Room Room in PlusEnvironment.GetGame().GetRoomManager().GetRooms())
                {
                    ...
                    if (Room == null || Room.GetRoomItemHandler() == null || Room.GetRoomItemHandler().GetWall == null)
                        continue;
                    ...
                    if (Room.RoomData.DriveEnabled)
                    {
                        ...
                        /*
                        #region *Zedd* Job Vehicle Respawn System
                        foreach (Item Item in Room.GetRoomItemHandler().GetFloor)
                        {
                            ...
                            if (Item.GetBaseItem().InteractionType == InteractionType.JOBCAR)
                            {
                        ...
                        #endregion *Zedd* Job Vehicle Respawn System
