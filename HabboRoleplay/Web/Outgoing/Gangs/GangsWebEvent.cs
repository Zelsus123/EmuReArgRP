                ...
                case "open":
                    {
                        ...
                        foreach (Group group in PlusEnvironment.GetGame().GetGroupManager().Groups.ToList())
                        {
                            ...
                            html += "</div>";
                            html += "<div class=\"bg-dark-2 px-2 py-1 rounded-lg ml-auto data-gang\" data-balloon=\"Ver info\" data-balloon-pos=\"left\" data-gang=\"" + group.Id + "\"><img src=\"http://republicargrp.tuholo.net/SWF/group-badge/badge.php?badge=" + group.GetBadge() + "\" draggable=\"false\" ondragstart=\"return false;\" style=\"cursor: pointer;\"></div>";
                            html += "</div>";
                        }
                        html += "</div>";
                        #endregion
                            ...
                            case "accept":
                                {
                                    ...
                                    if (PlusEnvironment.GetGame().GetClientManager().GetLevelById(Convert.ToInt32(GetUserId)) < 2)
                                    {
                ...
                case "invitations_re":
                    {
                        ...
                        {
                            dbClient.SetQuery("SELECT * FROM `group_requests` WHERE `user_id` = " + Client.GetHabbo().Id + " AND `invited` = '1'");
                            ...
                            if (PhOwn != null)
                            {
                                foreach (DataRow Row in PhOwn.Rows)
                                {
                                    ...
                                    html += "<center><div class=\"figure-H_RWF_0\" style=\"background-image: url(http://republicargrp.tuholo.net/SWF/group-badge/badge.php?badge=" + Gang.GetBadge() + "); width: 64px; height: 110px; margin-top: -20px;\"></div></center>";
                                    html += "</div>";
                ...
                case "stats":
                    {
                        ...
                        html += "<img src=\"http://republicargrp.tuholo.net/SWF/group-badge/badge.php?badge=/" + Groups[0].GetBadge() + "\" draggable=\"false\" ondragstart=\"return false;\">";
                        html += "</div>";
                        ...
                        if (Logs != null && Logs.Count > 0)
                        {
                            ...
                            foreach (var B in Logs)
                            {
                                ...
                                html += "<tr>";
                                html += "<td>";
                                html += "<img src=\"" + RoleplayManager.AVATARIMG + "" + hbo.Look + "&headonly=1\">";
                ...
                case "view_stats":
                    {
                        ...
                        html += "<div class=\"flex mb-2 items-center justify-center\">";
                        html += "<div id=\"Tool_Colours\" class=\"mr-3 colours-3DCMW_0\">";
                        html += "<img src=\"http://republicargrp.tuholo.net/SWF/group-badge/badge.php?badge=" + thegroup.GetBadge() + "\" draggable=\"false\" ondragstart=\"return false;\">";
                        html += "</div>";
                        html += "<div id=\"Tool_Text\" class=\"text-3xl font-bold uppercase text-white border-b-4 border-dark-3\">";
                        html += thegroup.Name;
                        html += "</div>";
