...
using Plus.Communication.Packets.Incoming.Alfas;
...
namespace Plus.Communication.Packets
{
    public sealed class PacketManager
    {
        ...
        private void RegisterCatalog()
        {
            ...
            this._incomingPackets.Add(ClientPacketHeader.TargetedOfferBuyEvent, new TargetedOfferBuyEvent());
        }
        ...
        private void RegisterGuides()
        {
            this._incomingPackets.Add(ClientPacketHeader.CallGuide, new CallGuide());
            this._incomingPackets.Add(ClientPacketHeader.AnswerGuideRequest, new AnswerGuideRequest());
            this._incomingPackets.Add(ClientPacketHeader.OpenGuideTool, new OpenGuideTool());
            this._incomingPackets.Add(ClientPacketHeader.InviteToRoom, new InviteToRoom());
            this._incomingPackets.Add(ClientPacketHeader.VisitRoom, new VisitRoom());
            this._incomingPackets.Add(ClientPacketHeader.GuideSpeak, new GuideSpeak());
            this._incomingPackets.Add(ClientPacketHeader.CloseGuideRequest, new CloseGuideRequest());
            this._incomingPackets.Add(ClientPacketHeader.CancelCallGuide, new CancelCallGuide());
            this._incomingPackets.Add(ClientPacketHeader.BullyRequestAccept, new BullyRequestAccept());
            this._incomingPackets.Add(ClientPacketHeader.BullyRequestVote, new BullyRequestVote());
            this._incomingPackets.Add(ClientPacketHeader.BullyRequestNoVote, new BullyRequestNoVote());
            this._incomingPackets.Add(ClientPacketHeader.VolverAmostrar, new VolverAmostrar());
            this._incomingPackets.Add(ClientPacketHeader.VolverAmostrar2, new VolverAmostrar2());
        ...
        private void RegisterRoomAction()
        {
            ...
            this._incomingPackets.Add(ClientPacketHeader.PollAnswerMessageEvent, new SubmitPollAnswerMessageEvent());
            this._incomingPackets.Add(ClientPacketHeader.NuxCloseMessageEvent, new NuxCloseMessageEvent());
        }
        ...
        private void RegisterSound()
        {
            ...
            this._incomingPackets.Add(ClientPacketHeader.GetJukeboxPlaylistMessageEvent, new GetJukeboxPlayListEvent());
            this._incomingPackets.Add(ClientPacketHeader.LoadJukeboxDiscsMessageEvent, new LoadJukeboxDiscsEvent());
            this._incomingPackets.Add(ClientPacketHeader.GetJukeboxDiscsDataMessageEvent, new GetJukeboxDiscsDataEvent());
            this._incomingPackets.Add(ClientPacketHeader.AddDiscToPlayListMessageEvent, new AddDiscToPlayListEvent());
            this._incomingPackets.Add(ClientPacketHeader.RemoveDiscFromPlayListMessageEvent, new RemoveDiscFromPlayListEvent());
        }
        ...
        private void RegisterFurni()
        {
            ...
            this._incomingPackets.Add(ClientPacketHeader.PurchaseRentableSpaceMessageEvent, new PurchaseRentableSpaceEvent());// NEW RP
            this._incomingPackets.Add(ClientPacketHeader.CancelRentableSpaceMessageEvent, new CancelRentableSpaceEvent());
        ...
        public void RegisterNames()
        {
            ...
            this._packetNames.Add(ClientPacketHeader.NuxCloseMessageEvent, "NuxCloseMessageEvent");
            this._packetNames.Add(ClientPacketHeader.OpenCalendarBoxMessageEvent, "CampaignCalendarGiftEvent");
            // Jukebox

            this._packetNames.Add(ClientPacketHeader.GetJukeboxPlaylistMessageEvent, "GetJukeboxPlayListEvent");
            this._packetNames.Add(ClientPacketHeader.LoadJukeboxDiscsMessageEvent, "LoadJukeboxDiscsEvent");
            this._packetNames.Add(ClientPacketHeader.GetJukeboxDiscsDataMessageEvent, "GetJukeboxDiscsDataEvent");
            this._packetNames.Add(ClientPacketHeader.AddDiscToPlayListMessageEvent, "AddDiscToPlayListEvent");
            this._packetNames.Add(ClientPacketHeader.RemoveDiscFromPlayListMessageEvent, "RemoveDiscFromPlayListEvent");
        }
    }
}