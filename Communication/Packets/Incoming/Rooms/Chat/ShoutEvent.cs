...
namespace Plus.Communication.Packets.Incoming.Rooms.Chat
{
    ...
    public class ShoutEvent : IPacketEvent
    {
        public void Parse(GameClient Session, ClientPacket Packet)
        {
            ...
            User.LastBubble = User.LastBubble != 0
    ? User.LastBubble // Usar LastBubbleId si está configurado (como en GobMode)
    : Session.GetHabbo().CustomBubbleId == 0
        ? Colour // Usar el color estándar si no hay burbuja personalizada
        : Session.GetHabbo().CustomBubbleId;
