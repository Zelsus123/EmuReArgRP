    ...
    class BanUserEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (House != null)
            {
                ...
                RoleplayManager.SendUserOld(User.GetClient(), House.RoomId, Session.GetHabbo().Username + " te ha expulsado de la casa.");
            }
            #endregion
            ...
            else if (ApartInside != null)
            {
                ...
                RoleplayManager.SendUserOld(User.GetClient(), ApartInside.LobbyId, Session.GetHabbo().Username + " te ha expulsado de l apartamento.");
            }
            #endregion
        }
    }
