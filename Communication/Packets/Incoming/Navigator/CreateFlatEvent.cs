...
namespace Plus.Communication.Packets.Incoming.Navigator
{
    class CreateFlatEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            {
                Session.SendNotification("No tienes permitido crear nuevas Zonas.");
                return;
            }
            ...
            RoomData NewRoom = PlusEnvironment.GetGame().GetRoomManager().CreateRoom(Session, Name, Description, ModelName, Category, City, MaxVisitors, TradeSettings);
            if (NewRoom != null)
            {
