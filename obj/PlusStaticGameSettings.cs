...
namespace Plus
{
    class PlusStaticGameSettings
    {
        ...
        /// <summary>
        ///     The amount of diamonds a user will receive every x minutes
        /// </summary>
        public const int UserDiamondsUpdateAmount = 0;

        /// <summary>
        ///     The time a user will have to wait for Credits/Pixels update in minutes
        /// </summary>
        public const int UserCreditsUpdateTimer = 900;
        ...
        /// </summary>
        public const int BannedPhrasesAmount = 5;
