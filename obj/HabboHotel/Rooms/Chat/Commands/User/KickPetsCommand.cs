...
namespace Plus.HabboHotel.Rooms.Chat.Commands.User
{
    class KickPetsCommand : IChatCommand
    {
        ...
        {
            get { return "Kicke a las mascotas de tu zona."; }
        }
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            if (Room.GetRoomUserManager().GetPets().Count > 0)
            {
                ...
                Session.SendWhisper("Macotas expulsadas exitosamente.", 1);
            }
            else
            {
                Session.SendWhisper("Al parecer no hay ninguna mascota.", 1);
            }
        }
    }
}
