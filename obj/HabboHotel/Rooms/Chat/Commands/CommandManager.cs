...
namespace Plus.HabboHotel.Rooms.Chat.Commands
{
    public class CommandManager
    {
        ...
        private void RegisterUser()
        {
            ...
            this.Register("pagar", new GiveCommand());
            ...
            this.Register("baul", new BaulCommand());
            this.Register("maletero", new BaulCommand());
            ...
            this.Register("radio", new RadioAlertCommand(), "police");
            this.Register("r", new RadioAlertCommand(), "police");
            this.Register("tradio", new ToggleRadioAlertCommand(), "police");
            this.Register("toggleradio", new ToggleRadioAlertCommand(), "police");
            #endregion            
