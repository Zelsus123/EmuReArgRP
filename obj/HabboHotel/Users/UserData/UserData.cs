...
namespace Plus.HabboHotel.Users.UserDataManagement
{
    public class UserData
    {
        ...
        public Dictionary<int, MessengerBuddy> groupchats;
        ...
        public UserData(int userID, ConcurrentDictionary<string, UserAchievement> achievements, List<int> favouritedRooms, List<int> ignores,
            List<Badge> badges, Dictionary<int, MessengerBuddy> friends, Dictionary<int, MessengerBuddy> groupchats, Dictionary<int, MessengerRequest> requests, List<RoomData> rooms, Dictionary<int, int> quests, Habbo user, 
