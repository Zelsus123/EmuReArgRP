    ...
    class KickUserEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            if (House != null)
            {
                ...
                RoleplayManager.SendUser(User.GetClient(), House.RoomId, Session.GetHabbo().Username + " te ha echado de la casa.");
            }
            #endregion
            ...
            else if (ApartInside != null)
            {
                ...
                RoleplayManager.SendUser(User.GetClient(), ApartInside.LobbyId, Session.GetHabbo().Username + " te ha echado del apartamento.");
            }
            #endregion
        }
    }
