...
namespace Plus.Communication.Packets.Incoming.Groups
{
    class PurchaseGroupEvent : IPacketEvent
    {
        public void Parse(HabboHotel.GameClients.GameClient Session, ClientPacket Packet)
        {
            ...
            Group Group = null;
            if (!PlusEnvironment.GetGame().GetGroupManager().TryCreateGroup(Session.GetHabbo(), 1, Name, Description, RoomId, Badge, Colour1.ToString(), Colour2.ToString(), "Indefinido", true, 0, out Group))
            {
