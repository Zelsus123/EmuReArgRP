...
namespace Plus.Communication.Packets.Outgoing.Handshake
{
    public class UserPerksComposer : ServerPacket
    {
            ...
            : base(ServerPacketHeader.UserPerksMessageComposer)
        {
            ...
            base.WriteString("");
            base.WriteBoolean(Habbo.GetPermissions().HasRight("acc_helper_use_guide_tool"));
            base.WriteString("GIVE_GUIDE_TOURS");
            base.WriteString("");
            base.WriteBoolean(Habbo.GetPermissions().HasRight("acc_helper_give_guide_tours"));
            base.WriteString("JUDGE_CHAT_REVIEWS");
            base.WriteString(""); // ??
            base.WriteBoolean(Habbo.GetPermissions().HasRight("acc_helper_judge_chat_reviews"));
