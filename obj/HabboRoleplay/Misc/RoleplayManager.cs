...
namespace Plus.HabboRoleplay.Misc
{
    public class RoleplayManager
    {
        ...
        #region PlayData
        // API
        public static string APIUrl = "https://" + Convert.ToString(RoleplayData.GetData("api", "apiurl"));
        ...
        public static string AVATARIMG = "https://images.kubbo.city/habbo-imaging/avatarimage?figure=";
        ...
        {
            // API
            APIUrl = "https://" + Convert.ToString(RoleplayData.GetData("api", "apiurl"));
        ...
        public static void SendUser(GameClient Client, int RID, string Message = "")
        {
            ...
            if (Client != null && roomData != null)
            {
                ...
                if (Client.GetPlay().IsJailed)
                {
                    ...
                    if (Room.Id != ToRoomId)
                    {
                        AddedToRoom(Client, Room, "jailed", ToRoomId);
                        return;
                    }
                }
                #endregion
                ...
                RoomUser ThisUser = Room.GetRoomUserManager().GetRoomUserByHabbo(Client.GetHabbo().Username);
        ...
        */
        ...
        public static void SaveQuickStat(int UserId, string Stat, string Newval)
        {
            using (IQueryAdapter dbClient = PlusEnvironment.GetDatabaseManager().GetQueryReactor())
            {
        ...
        public static void UnSanc(int UserId)
        {
            using (IQueryAdapter dbClient = PlusEnvironment.GetDatabaseManager().GetQueryReactor())
            {
                dbClient.RunQuery("UPDATE play_stats SET is_sanc = '0', sanc_time_left = '0' WHERE id = " + UserId + "; UPDATE users SET home_room = '1' WHERE id = " + UserId + ";");
            }
        }
        ...
        public static void DeleteRoomRP(GameClient Session, int RoomId)
        {
        ...
        public static void CallTaxi(GameClient Session, Room Room)
        {
            ...
            int Price = ruta.Count - 1;
            Session.GetHabbo().Credits -= (Price * RoleplayManager.TaxiCost);
        ...
        public static void DropTaxi(GameClient Session, string Username)
        {
            ...
            RoomUser TaxiBot = Session.GetHabbo().CurrentRoom.GetRoomUserManager().GetBotByName("Taxi#" + Username);
            if (TaxiBot == null)
                return;
        ...
        public static void TogglePassiveMode(GameClient Client)
        {
            ...
            if (Client.GetPlay().IsRobATM)
            {
                Client.SendWhisper("No puedes hacer eso mientras robas un cajero automático.", 1);
                return;
            }
            if (Client.GetPlay().IsForcingHouse)
            {
                Client.SendWhisper("No puedes hacer eso mientras robas una casa.", 1);
                return;
            }
            #endregion
