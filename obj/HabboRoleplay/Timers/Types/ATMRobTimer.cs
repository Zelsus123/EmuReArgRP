...
namespace Plus.HabboRoleplay.Timers.Types
{
    ...
    public class ATMRobTimer : RoleplayTimer
    {
        ...
        public override void Execute()
        {
            try
            {
                if (base.Client == null || base.Client.GetHabbo() == null || base.Client.GetPlay() == null || base.Client.GetPlay().IsDying || base.Client.GetPlay().IsDead || base.Client.GetPlay().IsJailed || !base.Client.GetPlay().IsRobATM || !base.Client.GetRoomUser().CanWalk || base.Client.GetRoomUser().Frozen)
                {
