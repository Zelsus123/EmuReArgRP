...
namespace Plus.HabboRoleplay.Timers.Types
{
    ...
    public class TaxiTimer : RoleplayTimer
    {
        ...
        public override void Execute()
        {
            try
            {
                if (base.Client == null || base.Client.GetHabbo() == null || base.Client.GetPlay() == null || base.Client.GetPlay().IsDying || base.Client.GetPlay().IsDead || base.Client.GetPlay().IsJailed || !base.Client.GetPlay().Pasajero || base.Client.GetPlay().ChoferName.Length <= 0)
                {
                    base.EndTimer();
                    return;
                }
