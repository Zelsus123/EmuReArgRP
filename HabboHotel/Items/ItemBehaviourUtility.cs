            ...
            switch (Item.GetBaseItem().InteractionType)
            {
                ...
                case InteractionType.wired_score_board:
                    ...
                    if (type != null)
                    {
                        ...
                        else
                        {
                            ...
                            Message.WriteInteger(0);
                            Message.WriteInteger(1);
                            Message.WriteString("The scoreboard does not yet exist :(");
                        }
                ...
                case InteractionType.GUILD_FORUM:
                    ...
                    else
                    {
                        ...
                        Message.WriteString(Group.Colour1); // Group Colour 1 PlusEnvironment.GetGame().GetGroupManager().GetGroupColour(Group.Colour1, true)
                        Message.WriteString(Group.Colour2); // Group Colour 2
                    }
                    break;
