...
using PlusEnvironment.HabboHotel.Items.Wired.Boxes.Effects;
...
namespace Plus.HabboHotel.Rooms.Instance
{
    public class WiredComponent
    {
        ...
        public bool isHighscore(Item Item)
        {
            return Item.GetBaseItem().InteractionType == InteractionType.WIRED_HIGHSCORE;
        }
