...
namespace Plus.HabboHotel.Rooms.Chat.Commands.Users.Generic.Offers
{
    class OpenCommand : IChatCommand
    {
        ...
        public void Execute(GameClients.GameClient Session, Rooms.Room Room, string[] Params)
        {
            ...
            if (Session.GetPlay().TryGetCooldown("open", true))
            {
                    ...
                    case "casa":
                        {
                            ...
                            if (HouseInside != null)// Estamos dentro de una casa
                            {
                                ...
                                {
                                    Session.SendWhisper("Tu casa ya está abierta.", 1);
                                    return;
                                }
                                HouseInside.OpenHouse(Session);
                            }
                            else // Estamos en un exterior
                            {
                                ...
                                House.OpenHouse(Session);
                            }
                            
                            RoleplayManager.Shout(Session, "*Abre la puerta de su Casa*", 5);
                            Session.GetPlay().CooldownManager.CreateCooldown("open", 1000, 5);
                            break;
                        }
                    #endregion
